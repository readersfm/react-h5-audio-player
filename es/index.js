...
class H5AudioPlayer extends Component {
        ...
        case RHAP_UI.SPEED:
          {
            ...
            return React.createElement(PlaybackSpeed, {
              audio: this.audio.current
            });
          }
        case RHAP_UI.SLEEP:
          {
            ...
            return React.createElement(SleepTimer, {
              audio: this.audio.current
            });
          }
        default:
  ...
  render() {
    ...
    return React.createElement("div", {
    ...
    }, this.renderUIModules([RHAP_UI.CURRENT_TIME]), React.createElement("div", {
      className: "rhap_volume-controls"
    }, React.createElement("div", {
      className: "rhap_time"
    }, this.props.middleText || '')), this.renderUIModules([RHAP_UI.DURATION])), React.createElement("div", {
      className: "rhap_progress-section"
    }, this.renderUIModules([RHAP_UI.PROGRESS_BAR])), React.createElement("div", {
      style: {
      ...
      className: "rhap_controls-section"
    }, this.renderUIModules([RHAP_UI.MAIN_CONTROLS])), React.createElement("div", {
      className: "rhap_controls-section"
    }, this.renderUIModules([RHAP_UI.SPEED, RHAP_UI.VOLUME_CONTROLS, RHAP_UI.SLEEP]))), footer && React.createElement("div", {
