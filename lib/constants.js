...
exports.SLEEP_TIMER = exports.RHAP_UI = exports.PLAYBACK_SPEED = void 0;
...
const PLAYBACK_SPEED = exports.PLAYBACK_SPEED = [0.8, 1, 1.2, 1.5, 1.8, 2, 3];
const SLEEP_TIMER = exports.SLEEP_TIMER = [{
  label: '2h',
  value: 60 * 2 * 60 * 1000
}, {
  label: '1h',
