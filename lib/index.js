...
var _PlaybackSpeed = _interopRequireDefault(require("./PlaybackSpeed"));
var _SleepTimer = _interopRequireDefault(require("./SleepTimer"));
...
class H5AudioPlayer extends _react.Component {
  constructor() {
    ...
    (0, _defineProperty2.default)(this, "renderUIModule", (comp, key) => {
      ...
      switch (comp) {
        ...
        case _constants.RHAP_UI.SPEED:
          {
            if (!this.props.showSpeedControl) return null;
            return _react.default.createElement(_PlaybackSpeed.default, {
              audio: this.audio.current
            });
          }
        case _constants.RHAP_UI.SLEEP:
          {
            if (!this.props.showSleepControl) return null;
            return _react.default.createElement(_SleepTimer.default, {
              audio: this.audio.current
            });
          }
        default:
  ...
  render() {
    ...
    return _react.default.createElement("div", {
    ...
    }, this.renderUIModules([_constants.RHAP_UI.CURRENT_TIME]), _react.default.createElement("div", {
      className: "rhap_volume-controls"
    }, _react.default.createElement("div", {
      className: "rhap_time"
    }, this.props.middleText || '')), this.renderUIModules([_constants.RHAP_UI.DURATION])), _react.default.createElement("div", {
      className: "rhap_progress-section"
    }, this.renderUIModules([_constants.RHAP_UI.PROGRESS_BAR])), _react.default.createElement("div", {
      style: {
      ...
      className: "rhap_controls-section"
    }, this.renderUIModules([_constants.RHAP_UI.MAIN_CONTROLS])), _react.default.createElement("div", {
      className: "rhap_controls-section"
    }, this.renderUIModules([_constants.RHAP_UI.SPEED, _constants.RHAP_UI.VOLUME_CONTROLS, _constants.RHAP_UI.SLEEP]))), footer && _react.default.createElement("div", {
...
(0, _defineProperty2.default)(H5AudioPlayer, "defaultProps", {
  ...
  customAdditionalControls: [_constants.RHAP_UI.LOOP, _constants.RHAP_UI.SPEED, _constants.RHAP_UI.SLEEP],
